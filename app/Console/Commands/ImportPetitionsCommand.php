 ...
 *
 * Usage: php artisan import:petitions /path/to/file.xlsx [--commit] [--rollback=batch_id]
 *
 * Sample
 * Do a dry run to preview the import without making any changes (default)
 * Usage: php artisan import:petitions storage/imports/data.xlsx
 *
 * Run the import and commit changes to database
 * Usage: php artisan import:petitions storage/imports/data.xlsx --commit
 * Output: Batch ID: import_1738675200
 *
 * If something went wrong, rollback
 * Usage: php artisan import:petitions --rollback=import_1738675200
 */
class ImportPetitionsCommand extends Command
{
    ...
    protected $description = 'Import an Excel file and insert data into petition table';
