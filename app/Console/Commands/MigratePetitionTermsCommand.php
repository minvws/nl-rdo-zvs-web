 ...
 */
#[AsCommand(name: 'app:migrate-petition-terms', description: 'Migrate petition terms to petition events')]
final class MigratePetitionTermsCommand extends Command
{
    ...
    protected $signature = 'app:migrate-petition-terms {zaaknummer} {--commit} {--overwrite}';

    protected $description = 'Migrate petition terms to petition events';
