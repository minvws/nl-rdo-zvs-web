...
readonly class PetitionEventsPersistenceAction
{
    ...
    /**
     * @param array<int, array{type: string, date: string, duration?: int|null, penalties?: array<int, array{amount: int, duration: int}>, suspension_type?: string|null, result_type?: string|null, hearing_form?: string|null, created_at: mixed}> $petitionEventDataArray
     *
     * @throws Throwable
     */
