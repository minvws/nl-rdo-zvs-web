...
#[CoversClass(CustomDatesAdjustAction::class)]
class CustomDatesAdjustActionTest extends FeatureTestCase
{
    #[Test]
    public function adjustsCustomDateLabelsSuccessfully(): void
    {
        ...
        $action = $this->app->make(CustomDatesAdjustAction::class);
        $action->execute($petitionType, CustomDateLabel::DATE_PUBLIC_HEARING, CustomDateLabel::DATE_COURT_SESSION);
    ...
    #[Test]
    public function onlyUpdatesCustomDatesForSpecificPetitionType(): void
    {
        $date = $this->faker->calendarDate();
        ...
        $action = $this->app->make(CustomDatesAdjustAction::class);
        $action->execute($petitionType1, CustomDateLabel::DATE_PUBLIC_HEARING, CustomDateLabel::DATE_COURT_SESSION);
