...
@section('pageTitle', __('contact.edit'))

<x-form-layout>
    <x-slot name="header">
        <h1>{{ __('contact.edit') }}</h1>
    </x-slot>
    ...
    <section class="mt-5">
        <div class="visually-grouped">
            <form
                method="post"
                action="{{ route(RouteName::DEPARTMENTS_CONTACTS_EDIT, ['department' => $department, 'contact' => $contact]) }}">
                @csrf
                        ...
                        <select
                            ...
                            @foreach (ContactType::cases() as $contactType)
                                <option
                                    ...
                                    @selected($contactType->value === Form::old('type', $contact->type->value))>
                    ...
                    <div class="form-row form-row--two-one-six">
                        <div>
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('initials', $contact->initials) }}" />
                        </div>
                        <div>
                            <x-input-label
                                for="middle_name"
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('middle_name', $contact->middle_name) }}" />
                        </div>
                        <div>
                            <x-input-label
                                for="last_name"
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('last_name', $contact->last_name) }}" />
                        </div>
                    </div>
                    <div>
                        <x-input-label
                        ...
                        <x-text-input
                            ...
                            value="{{ Form::old('organisation_name', $contact->organisation_name) }}" />
                    </div>
                    <div>
                        <x-input-label
                            for="email_address"
                        ...
                        <x-text-input
                            ...
                            value="{{ Form::old('email_address', $contact->email_address) }}" />
                    </div>
                    <div>
                        <x-input-label
                        ...
                        <x-text-input
                            ...
                            value="{{ Form::old('secondary_email_address', $contact->secondary_email_address) }}" />
                    </div>
                    <div>
                        <x-input-label
                            for="phone_number"
                        ...
                        <x-text-input
                            ...
                            value="{{ Form::old('phone_number', $contact->phone_number) }}" />
                    </div>
                    <div>
                        <x-input-label
                            for="notes"
                        ...
                        <textarea
                            class="form-control"
                            id="notes"
                            name="notes">{{ Form::old('notes', $contact->notes) }}</textarea>
                    </div>

                    <legend>{{ __('contact.physical_address') }}</legend>
                    <div class="form-row form-row--three-quarters">
                        <div>
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('street', $contact->street) }}" />
                        </div>
                        <div>
                            <x-input-label
                                for="house_number"
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('house_number', $contact->house_number) }}" />
                        </div>
                    </div>
                    <div class="form-row form-row--one-third">
                        <div>
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('postal_code', $contact->postal_code) }}" />
                        </div>
                        <div>
                            <x-input-label
                                for="city"
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('city', $contact->city) }}" />
                        </div>
                    </div>
                </fieldset>
                <fieldset class="mt-4">
                    ...
                    <div class="form-row form-row--three-quarters">
                        <div>
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('visiting_address_street', $contact->visiting_address_street) }}" />
                        </div>
                        <div>
                            <x-input-label
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('visiting_address_house_number', $contact->visiting_address_house_number) }}" />
                        </div>
                    </div>
                    <div class="form-row form-row--one-third">
                        <div>
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('visiting_address_postal_code', $contact->visiting_address_postal_code) }}" />
                        </div>
                        <div>
                            <x-input-label
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('visiting_address_city', $contact->visiting_address_city) }}" />
                        </div>
                    </div>
                </fieldset>
                <fieldset class="mt-4">
                    ...
                    <div class="form-row form-row--three-quarters">
                        <div>
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('postal_address_street', $contact->postal_address_street) }}" />
                        </div>
                        <div>
                            <x-input-label
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('postal_address_house_number', $contact->postal_address_house_number) }}" />
                        </div>
                    </div>
                    <div class="form-row form-row--one-third">
                        <div>
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('postal_address_postal_code', $contact->postal_address_postal_code) }}" />
                        </div>
                        <div>
                            <x-input-label
                            ...
                            <x-text-input
                                ...
                                value="{{ Form::old('postal_address_city', $contact->postal_address_city) }}" />
                        </div>
                    </div>
                </fieldset>
                <fieldset class="mt-4">
                    ...
                    <div>
                        ...
                        <x-text-input
                            ...
                            value="{{ Form::old('email_address_2', $contact->email_address_2) }}" />
                    </div>
                    <div>
                        <x-input-label
                            for="email_address_3"
                        ...
                        <x-text-input
                            ...
                            value="{{ Form::old('email_address_3', $contact->email_address_3) }}" />
                    </div>
                </fieldset>
                        ...
                        @can(Permission::CONTACT_WRITE->value)
                            @if ($contact->archived_at === null)
                                <a
                                    href="{{
                                        confirmRoute(
                                            route(RouteName::DEPARTMENTS_CONTACTS_ARCHIVE_STORE, ['department' => $department, 'contact' => $contact]),
                                            route(RouteName::DEPARTMENTS_CONTACTS_SHOW, ['department' => $department, 'contact' => $contact]),
                                            __('contact.archive_confirmation_text', ['name' => $contact->display_name]),
                                        )
                                    }}"
                                    class="button">
                                    {{ __('contact.archive') }}
