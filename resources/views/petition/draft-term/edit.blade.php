...
@section('pageTitle', __('draft_term.edit'))

<x-form-layout>
    <x-slot name="header">
        <h1>{{ __('draft_term.edit') }}</h1>
    </x-slot>
    ...
    <section class="mt-5">
        <div class="visually-grouped">
            <form
                method="post"
                action="{{ route(RouteName::DEPARTMENTS_PETITIONS_DRAFT_TERM_UPDATE, ['department' => $petition->department->slug, 'petition' => $petition]) }}">
                @csrf
                ...
                <section>
                    ...
                    <div class="form-input-group">
                        ...
                        <input
                            ...
                            type="text"
                            name="description"
                            value="{{ Form::old('description', $draftTerm->description) }}"
                            maxlength="255"
                    ...
                    <div class="form-input-group">
                        ...
                        <input
                            ...
                            type="date"
                            name="event_date"
                            value="{{ Form::old('event_date', $draftTerm->event_date?->format('Y-m-d')) }}"
                    ...
                    <div class="form-input-group">
                        ...
                        <x-text-input
                            ...
                            :value="Form::old('days_after_event', $draftTerm->days_after_event)"
                    ...
                    <div class="form-input-group">
                        ...
                        <input
                            ...
                            value="{{ Form::old('date_withdrawal', $draftTerm->date_withdrawal?->format('Y-m-d')) }}"
                    ...
                    <div class="form-input-group">
                        ...
                        <x-text-input
                            ...
                            :value="Form::old('days_after_date_withdrawal', $draftTerm->days_after_date_withdrawal)"
