@section('pageTitle', __('petition_deliverable.edit', ['petition_deliverable_type' => __(sprintf('petition_deliverable.petition_deliverable_type.%s', $petitionDeliverable->type->value))]))

<x-form-layout>
    <x-slot name="header">
        <h1>
            {{ __('petition_deliverable.edit', ['petition_deliverable_type' => __(sprintf('petition_deliverable.petition_deliverable_type.%s', $petitionDeliverable->type->value))]) }}
        </h1>
    </x-slot>
            ...
            <form
                ...
                <div class="form-input-group">
                    ...
                    <input
                        ...
                        type="date"
                        name="deadline_at"
                        value="{{ Form::old('deadline_at', $petitionDeliverable->deadline_at) }}" />
                </div>
                ...
                <div>
                    ...
                    <x-text-input
                        ...
                        value="{{ Form::old('description', $petitionDeliverable->description) }}" />
                </div>
