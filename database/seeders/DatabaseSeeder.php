        ...
        foreach ($bezwaarPetitionTypes as $bezwaarPetitionType) {
            CustomPetitionProperty::factory()
                ...
                ->state(new Sequence(
                    ...
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 9, 'name' => 'Gegrond', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 10, 'name' => 'Kennelijk gegrond', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 11, 'name' => 'Ongegrond', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 12, 'name' => 'Kennelijk ongegrond', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 13, 'name' => 'Niet-ontvankelijk', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 14, 'name' => 'Kennelijk niet-ontvankelijk', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::SUBTITLE, 'ordering' => 15, 'name' => 'Doorzending'],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 16, 'name' => 'Doorzending', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 17, 'name' => 'Intrekking bezwaar', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 18, 'name' => 'Herziening – herstel bezwaar', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 19, 'name' => 'Herziening – herstel primair besluit', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 20, 'name' => 'Informeel', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 21, 'name' => 'Overig', 'grouping' => 4],
                    ...
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 24, 'name' => 'A', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 25, 'name' => 'B', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 26, 'name' => 'C', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 27, 'name' => 'D', 'grouping' => 4],
                    ['type' => CustomPetitionPropertyType::OPTION, 'ordering' => 28, 'name' => 'E', 'grouping' => 4],
                ))
